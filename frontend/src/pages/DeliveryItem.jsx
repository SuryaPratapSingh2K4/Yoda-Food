...
function DeliveryItem() {
    ...
    return (
        <div className='p-8 mt-6'>
            ...
            {image && (
                <div className='w-[350px] h-[350px] flex justify-center items-center border border-black rounded-lg mb-4'>
                    <img src={image} className="h-[350px] object-cover rounded-lg mb-4" />
                </div>
            )}
            ...
            <button
                ...
                className='flex items-center gap-2 border border-gray-400 px-4 py-2 rounded-lg bg-green-600 text-white font-semibold hover:bg-green-700 hover:scale-105 transition duration-300'
            >
