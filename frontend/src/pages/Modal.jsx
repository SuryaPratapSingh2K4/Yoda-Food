...
function Modal() {
    ...
    return (
        <div className='p-8 mt-8 flex flex-row gap-4 ' key={id}>
            <ArrowBigLeftDashIcon size={60} onClick={handleBack} className='cursor-pointer'/>
            <div className='flex flex-col'>
                <h1 className='text-2xl py-4'>Product Detail of {state.title}</h1>
                {image && <div className='w-[440px] h-[440px] flex justify-center items-center border border-black rounded-lg mb-4'>
                    <img src={image} className="h-[520px] object-cover rounded-lg mb-4" /></div>}
